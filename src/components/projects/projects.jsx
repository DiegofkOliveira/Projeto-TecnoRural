    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:3000/enviar-formulario', {
                ...
                // Remova o cabeçalho "Content-Type" para evitar conflitos com FormData
                // headers: { "Content-Type": "application/json" }, // Removido
            });

            const result = await response.text(); // Obtém a resposta textual
            ...
            // Adicione mais detalhes no erro para depuração
