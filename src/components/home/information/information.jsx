...
function Information() {
    return (
        <div className="w-full h-auto min-h-screen flex flex-col items-center justify-center bg-no-repeat bg-cover bg-center bg-[linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url('/ImagemInfo.jpg')]">
